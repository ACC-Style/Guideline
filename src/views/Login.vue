	...
	<div class="home texture_light padding_4" style="height:100vh;">
		<div class="grid-x">
			<div class="cell small-10 medium-8 large-6 margin_auto">
				<div>
					<h1 class="logo-lockup padding-bottom_3"><img src="assets/img/mobileLogo.svg" alt="American College of Cardiology" class="logo"><span class="text">Guideline<br>CMS</span></h1>
				</div>
